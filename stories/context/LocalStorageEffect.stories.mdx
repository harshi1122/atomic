...
<Meta title="State Management/Effects/Local Storage" />
...
|--------------	|--------------	|--------------	|---------------------------------------------------------------------------------------------------------------------------------------------	|
| `key`       	| `true`       	| `-`         	| The [`keyName`](https://developer.mozilla.org/en-US/docs/Web/API/Storage/setItem#parameters) used to reference this value in local storage. 	|
